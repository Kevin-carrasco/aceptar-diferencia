...
```{r results='asis', message=FALSE, echo=FALSE}  
htmlreg(list(reg4, reg6, reg7, reg11, reg12, reg13, reg14), 
         custom.model.names = c("Modelo 1",
                               "Modelo 2",
                               "Modelo 3",
                               "Modelo 4",
        ...
        custom.coef.names = c("Intercepto", 
                              ...
                              "Más de 25 libros * Conocimiento Cívico D",
                              "Más de 25 libros * Conocimiento Cívico C",
                              "Más de 25 libros * Conocimiento Cívico B",
                              "Más de 25 libros * Conocimiento Cívico A",
                              "Educación Media * Promedio discusión en sala",
                              "Educación Técnica * Promedio discusión en sala",
                              "Educación universitaria * Promedio discusión en sala",
                              "Educación Ns/Nr * Promedio discusión en sala",
                              "Más de 25 libros * Promedio discusión en sala"
                              ),
        caption = "Aceptar la diversidad en el vecindario",
        caption.above = TRUE,
        encoding = "UTF-8",
