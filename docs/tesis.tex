...
En el Gráfico \ref{fig:hipotesis} se incluye un esquema que resume las hipótesis planteadas:
...
En el Gráfico \ref{fig:hipotesis2} se muestra el modelo teórico que resume los resultados de las hipótesis planteadas. Con ``+'' se representan las hipótesis que obtuvieron una asociación positiva y con ``\textbar{}'' se representan las hipótesis que no tuvieron resultados estadísticamente significativos. No hay hipótesis que obtuvieran asociaciones negativas estadísticamente significativas.
